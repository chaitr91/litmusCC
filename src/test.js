(function() {
  angular.module('app', ['angularPaho', 'nvd3']);
})();

(function() {
  angular.module('app').controller('test', [ '$scope', 'MqttClient', 'dataShare', function($scope, MqttClient, dataShare) {
...
(function(){
  angular.module('app')
      ...
      .controller('historicalBarChartCtrl', function($scope, dataShare){
...
(function() {
  angular.module('app').service('dataShare', function($rootScope){
    data = "HI"
    function set(val){
      //console.log('in', val)
      data = val
...
(function() {
  ...
  app.controller('LoginController', function($scope, $rootScope, $stateParams, $state, LoginService) {
    $rootScope.title = "Litumus Automation Login";
